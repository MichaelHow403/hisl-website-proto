...
// Enhanced Earth component with realistic colors and lighting
    ...
    <group>
      ...
      <mesh ref={earthRef}>
        ...
        <meshStandardMaterial
          ...
          roughness={0.7}
          metalness={0.05}
          // Enhanced color properties for vibrant appearance
          color="#ffffff"
          emissive="#001122"
...
// Enhanced atmosphere glow effect with realistic blue rim
function Atmosphere() {
  return (
    <group>
